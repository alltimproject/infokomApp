...
class Home extends CI_Controller{
  ...
  {
    $data['title'] = 'HRD Home';
    $this->load->view('hrd/include/v_header', $data);
    $this->load->view('hrd/v_home');
    $this->load->view('hrd/include/v_footer');
  }
  function fetch()
  {
         ...
         <tbody>
          ...
          $output .= '
            <form id="simpan-gaji" method="post">
              ...
              <a href='.base_url('hrd/home/hapusabsensi?nip='.$nip).' class="btn btn-danger">BATALKAN</a>
            </form>
          ';
